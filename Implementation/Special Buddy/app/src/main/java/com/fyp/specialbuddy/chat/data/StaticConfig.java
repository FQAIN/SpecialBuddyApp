package com.fyp.specialbuddy.chat.data;
...
public class StaticConfig {
    ...
    public static String STR_EXTRA_GENDER= "gender";
    public static String STR_EXTRA_DISABILITY= "disability";
    public static String STR_EXTRA_PASSWORD = "password";
    public static String STR_EXTRA_LAT = "mLat";
    public static String STR_EXTRA_LONG = "mLong";
